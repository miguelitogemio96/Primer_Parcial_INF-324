...
<body>
    ...
    <div class="post">
        <article>
            ...
            <p class="extracto"><span class="nombre">NUEVO DOCENTE</span></p>
            <table>
                <thead>
                    <tr>
                    <th>Ci</th><th>Usuario</th><th>Contraseña</th>
                    </tr>
                </thead>
                
                <tr>
                <form name="agregar" action="http://localhost/PrimerParcial/Pregunta_5/Code/index.php/Nuevo_Docente" class="formulario" method="POST">
                    
                    <td>
                        <input type="text" name="ci" placeholder="12345678">
                    </td>
                    <td>
                        <input type="text" name="usuario" placeholder="abc">
                    </td>
                    <td>
            ...
            <thead>
                <tr>
                    <th>Nombre</th><th>fnacimiento</th><th>Departamento</th>                    </tr>
                    <tr>
                        <td>
                            <input type="text" name="nombre" placeholder="abc">
                        </td>
                        <td>
                            <input type="date" name="fnacimiento" placeholder="yyyy-mm-dd">
                        </td>
                        <td>
                            <input type="text" name="departamento" placeholder="00">
                        </td>
                    </tr>
                </thead>
        ...
        <ul>
            <li><a onclick="agregar.submit()">Agregar Docente</a></li>
        </ul>
        </section>
