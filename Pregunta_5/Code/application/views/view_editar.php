...
<body>
    ...
    <div class="post">
        <article>
            ...
            <div class="thumb">                
                 <img src="C:\Program Files\Ampps\www\PrimerParcial\Pregunta_5\Code\application\fac.png" alt="logo carrera">
            </div>
            <p class="extracto">USUARIO: <span class="nombre"><?php echo $usuario; ?></span></p>
            </br>
            <p class="extracto"><span class="nombre">ACTUAL</span></p>
            <table>
                <thead>
                    <tr>
                        <th>Ci</th><th>Nombre</th><th>fnacimiento</th><th>Cod Departamento</th>
                    </tr>
                </thead>
                <?php 
                    $docente = $docente[0];
                    ...
                    echo "<td>".$docente->fnacimiento ."</td>";
                    echo "<td>".$docente->departamento ."</td>";
                    echo "</tr>";
                
                ?>
                             
		    </table>
            <p class="extracto"><span class="nombre">NUEVO</span></p>
            <table>
                <thead>
                    <tr>
                        <th>Nombre</th><th>fnacimiento</th><th>Cod Departamento</th><th>Opciones</th>
                    </tr>
                </thead>
                
                <tr>
                <form action="http://localhost/PrimerParcial/Pregunta_5/Code/index.php/Modificar?ci=<?php echo $docente->ci ;?>" class="formulario" method="POST">
                    <td>
                        <input type="text" name="nombre" placeholder="abc" value="<?php echo $docente->nombre ;?>">
                    </td>
                    <td>
                        <input type="date" name="fnacimiento" placeholder="yyyy-mm-dd" value="<?php echo $docente->fnacimiento ;?>">
                    </td>
                    <td>
                        <input type="text" name="departamento" placeholder="00" value="<?php echo $docente->departamento ;?>">
                    </td>
                    <td>
