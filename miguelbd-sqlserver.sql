create database miguelbd2;

CREATE TABLE personas ( ci VARCHAR(10) NOT NULL , nombre VARCHAR(50) NOT NULL , fnacimiento DATE NOT NULL , departamento VARCHAR(2) NOT NULL , PRIMARY KEY (ci));

CREATE TABLE notas ( ci VARCHAR(10) NOT NULL , sigla VARCHAR(7) NOT NULL , nota1 INT NOT NULL , nota2 INT NOT NULL , nota3 INT NOT NULL , notaf INT NOT NULL );
